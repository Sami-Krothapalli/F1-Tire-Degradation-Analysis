...
\reportfigure{tire_life_counts.png}{Number of laps available at each tire age by compound. This figure is used as a data-quality check before interpreting high tire ages.}{fig:tire-counts}

\reportfigure{adjusted_pace_delta.png}{Median adjusted pace delta by tire life and compound after cleaning and race-context adjustment.}{fig:adjusted-pace}
...
\reportfigure{spline_model.png}{Spline model predictions for adjusted pace delta by tire life and compound.}{fig:spline}
...
\reportfigure{segmented_regression.png}{Segmented regression fits with estimated breakpoints for each tire compound.}{fig:segmented}
...
\reportfigure{regression_tree.png}{Regression tree for predicting adjusted pace delta using tire, speed, team, race, and year variables.}{fig:tree}
...
\reportfigure{model_comparison_rmse.png}{Model comparison by test RMSE. Lower RMSE indicates better predictive accuracy.}{fig:rmse}
